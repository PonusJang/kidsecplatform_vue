...
<script>
  ...
  import {findByAssets, findByMonth, getList, getAllList, findByIp} from '@/api/result2'
      ...
      getList() {
        ...
        if (this.listQuery.ip !== undefined && this.listQuery.ip !== '') {
          findByIp(this.listQuery.page, this.listQuery.limit, this.listQuery.ip).then(response => {
            ...
            this.listQuery.assets = undefined
            setTimeout(() => {
              this.listLoading = false
            }, 1.5 * 1000)
          })
        } else if (this.listQuery.assets !== undefined && this.listQuery.assets !== '') {
        ...
        } else if (this.listQuery.selectMonth !== undefined && this.listQuery.selectMonth !== '') {
          findByMonth(this.listQuery.page, this.listQuery.limit, this.listQuery.selectMonth.getMonth() + 1).then(response => {
            this.total = response.data.count
            this.list = response.data.data
            this.listQuery.selectMonth = undefined
            setTimeout(() => {
              this.listLoading = false
            }, 1.5 * 1000)
          })
