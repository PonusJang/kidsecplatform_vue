<template>
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.port" placeholder="端口" style="width: 200px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
      <el-input v-model="listQuery.service" placeholder="服务" style="width: 200px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
